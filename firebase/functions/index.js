...
// Test credentials
const kTestMerchantId = "czbsx9zswzgfw6rg";
const kTestPublicKey = "trmtwxffk6gk2kq5";
const kTestPrivateKey = "1104e5ebadeda396aa74afff71cb9549";
 ...
 *
 */
exports.processBraintreePayment = functions
  .region("us-central1")
 ...
 *
 */
exports.processBraintreeTestPayment = functions
  .region("us-central1")
  .https.onCall(async (data, context) => {
    if (!context.auth) {
      return "Unauthenticated calls are not allowed.";
