...
import 'list_vi_copy_copy_model.dart';
export 'list_vi_copy_copy_model.dart';

class ListViCopyCopyWidget extends StatefulWidget {
  const ListViCopyCopyWidget({
    super.key,
    this.map,
  });
  ...
  static String routeName = 'List_viCopyCopy';
  static String routePath = '/listViCopyCopy';

  @override
  State<ListViCopyCopyWidget> createState() => _ListViCopyCopyWidgetState();
}

class _ListViCopyCopyWidgetState extends State<ListViCopyCopyWidget>
    with TickerProviderStateMixin {
  late ListViCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListViCopyCopyModel());
                        ...
                        child: Padding(
                          ...
                          child: Material(
                            ...
                            child: ListTile(
                              title: Text(
                                FFLocalizations.of(context).getText(
                                  'paylzbad' /* You are currently browsing: */,
                                ),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(ListViCopyCopyWidget.routeName);
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              context.goNamed(ListViCopyCopyWidget.routeName);
                            },
                            child: Material(
                              color: Colors.transparent,
                              child: ListTile(
                                ...
                                title: Text(
                                  FFLocalizations.of(context).getText(
                                    'h6vni5ld' /* Add a place from the map. */,
                                  ),
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
