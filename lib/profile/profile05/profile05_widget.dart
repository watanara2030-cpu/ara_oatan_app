              ...
              children: [
                      ...
                      builder: (context) => InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataMcf = true);
                            ...
                            if (selectedUploadedFiles.length ==
                              ...
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataMcf =
                                    selectedUploadedFiles.first;
                                _model.uploadedFileUrl_uploadDataMcf =
                                    downloadUrls.first;
                              });
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      context.pushNamed(PaymetHostreWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      decoration: BoxDecoration(
                ...
                if ((Theme.of(context).brightness == Brightness.dark) == false)
                  Padding(
                    padding: const EdgeInsetsDirectional.fromSTEB(
                        16.0, 12.0, 16.0, 0.0),
                    child: Container(
                            ...
                            builder: (alertDialogContext) {
                              return WebViewAware(
                                child: AlertDialog(
                                  ...
                                  content: const Text(
                                      'هل  انت متأكد من إرسال طلب حذف الحساب ؟ سوف يستغرق حذف الحساب 24 ساعة في حال عدم وجود مبالغ معلقة او رصيد  '),
                                  actions: [
                                    TextButton(
                          ...
                          builder: (alertDialogContext) {
                            return WebViewAware(
                              child: AlertDialog(
                                ...
                                content: const Text(
                                    'يمكنك متابعة حالة الطلب من خلال تذاكر الدعم الفني'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
