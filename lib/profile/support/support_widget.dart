                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(NewSupportTicketWidget.routeName);
                          },
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      'تذكرة رقم ${listViewSupportRecord.id.toString()}',
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            listViewSupportRecord.halh?.name,
                                            'لايوجد',
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodySmall
