        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Padding(
                padding:
                    const EdgeInsetsDirectional.fromSTEB(0.0, 37.0, 0.0, 5.0),
                child: Row(
                  mainAxisSize: MainAxisSize.max,
                                                              ...
                                                              if (rowSettingsRecord
                                                                ...
                                                                FFButtonWidget(
                                                                  ...
                                                                  text: FFLocalizations.of(
                                                                          context)
                                                                      .getText(
                                                                    'jkbikolm' /* Create an account with Google */,
                                                                  ),
                                                                  icon:
                                                                      const FaIcon(
                                                                    FontAwesomeIcons
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              TextFormField(
                                                                ...
                                                                minLines: 1,
                                                                validator: _model
                                                                    .confpassTextControllerValidator
                                                                    .asValidator(
                                                                        context),
                                                              ),
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  await launchURL(
                                                                      'https://araoatanapp.odoo.com/sys-lkhswsy');
                                                                },
                                                                child: Text(
                                                                  FFLocalizations.of(
                                                                          context)
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '9aqp464r' /* Welcome to Become a Success Pa... */,
                                                      ),
                                                      textAlign:
                                                          TextAlign.center,
                                                      style:
                                                    ...
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'pn8l7q33' /* Join us as a Success Partner t... */,
                                                      ),
                                                      textAlign:
                                                          TextAlign.center,
                                                      style:
